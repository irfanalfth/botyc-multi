...
const collectCoin = (token, detail) => {
      ...
      if (message !== "Success") {
        ...
        try {
          if (recoveryCount > 0) {
            ...
            console.log(
              `[ ${moment().format("HH:mm:ss")} ] Success! Recovery Coint`
            );
            ...
            console.log(
              `[ ${moment().format(
                "HH:mm:ss"
              )} ] Energy 0 & Recovery 0! Delay 10 Second`
            );
...
const start = async () => {
  try {
    while (true) {
      ...
      console.log("========================================");
      console.log(
        `[ ${moment().format("HH:mm:ss")} ] All Token Claimed! Delay 3 Minute`
      );
      await delay(180000);
    }
  } catch (error) {
    console.clear();
    console.error("Error occurred. Restarting the process...");
    start();
  }
};
